# Generated by Django 4.0.6 on 2022-08-31 14:32
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.CharField(choices=[('completed', 'completed'), ('not handled', 'not handled'), ('on the way', 'on the way')], default='not handled', max_length=200)),
