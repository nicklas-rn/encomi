...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.CharField(choices=[('not handled', 'not handled'), ('on the way', 'on the way'), ('completed', 'completed')], default='not handled', max_length=200)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('selected_style', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='shop.style')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('seller', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='shop.seller')),
